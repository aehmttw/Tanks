...
public class Screen extends JFrame 
{
	...
	public static int mouseXoffset = -11;
	...
	{
		return ((MouseInfo.getPointerInfo().getLocation().getY() - this.getLocation().getY() - Math.max(0, Game.gamescreen.getSize().getHeight() - (offset + 1) - Screen.sizeY * Screen.scale) / 2)) / scale + mouseYoffset / Screen.scale;
	}
