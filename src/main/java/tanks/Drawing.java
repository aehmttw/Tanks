...
public class Drawing
{
     ...
     * 0: default
     * <p>
     * +1 hide behind face +2 hide front face +4 hide bottom face +8 hide top face
     * +16 hide left face +32 hide right face
     * <p>
     * +64 draw on top
     */
    ...
    public double gameToInterfaceCoordsX(double x)
    {
        ...
        /*
         * double rawX = (x + getPlayerMouseOffsetX()) * scale; rawX +=
         * (Drawing.drawing.interfaceSizeX - sizeX * scale / interfaceScale) / 2 *
         * interfaceScale; double x1 = rawX / interfaceScale;
         *
         * if (enableMovingCamera && movingCamera && enableMovingCameraX) x1 -=
         * (Game.game.window.absoluteWidth - interfaceScale * interfaceSizeX) / 2 /
         * interfaceScale;
         *
         * return x1;
         */
    ...
    public double gameToInterfaceCoordsY(double y)
    {
        ...
        /*
         * double rawY = (y + getPlayerMouseOffsetY()) * scale; rawY +=
         * (Drawing.drawing.interfaceSizeY - sizeY * scale / interfaceScale) / 2 *
         * interfaceScale; double y1 = rawY / interfaceScale;
         *
         * if (enableMovingCamera && movingCamera && enableMovingCameraY) y1 -=
         * (Game.game.window.absoluteHeight - interfaceScale * interfaceSizeY -
         * statsHeight) / 2 / interfaceScale;
         *
         * return y1;
         */
    }
    ...
    /*
     * public void setScreenSize(int x, int y) { sizeX = x; sizeY = y;
