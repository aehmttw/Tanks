    ...
    public void drawUpdate(ArrayList<Firework> current, ArrayList<Firework> next)
    {
        ...
        if (type == FireworkType.rocket)
        {
            ...
            if (this.age >= this.maxAge && !this.exploded)
            {
                ...
                // double var = 50;
                // e.colorR = Math.min(255, Math.max(0, this.colorR + Math.random() * var - var
                // / 2));
                // e.colorG = Math.min(255, Math.max(0, this.colorG + Math.random() * var - var
                // / 2));
                // e.colorB = Math.min(255, Math.max(0, this.colorB + Math.random() * var - var
                // / 2));
                // e.posZ = this.posZ;
                // e.vX = this.vX;
                // e.vY = this.vY;
                ...
                // else
                // e.add3dPolarMotion(Math.random() * Math.PI * 2, Math.asin(Math.random() * 2 -
                // 1), power);
                //
                // e.maxAge = e.size * 40;
                // }
