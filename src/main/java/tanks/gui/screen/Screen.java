...
public abstract class Screen implements IBatchRenderableObject
{
    ...
    public void drawDefaultBackground(double size)
    {
        ...
        if (this instanceof ScreenGame || this instanceof ILevelPreviewScreen
                || (this instanceof IOverlayScreen && !(this instanceof IConditionalOverlayScreen && !((IConditionalOverlayScreen) this).isOverlayEnabled())))
        ...
        {
            Drawing.drawing.setColor(174 * frac + (1 - frac) * Level.currentColor.red, 92 * frac + (1 - frac) * Level.currentColor.green,
                    16 * frac + (1 - frac) * Level.currentColor.blue);
