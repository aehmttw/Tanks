...
public class ScreenInfo extends Screen implements IConditionalOverlayScreen, IDarkScreen
{
    ...
    public void draw()
    {
        ...
        {
            Drawing.drawing.drawInterfaceText(Drawing.drawing.interfaceSizeX / 2 - 320, Drawing.drawing.interfaceSizeY / 2 + (i - (text.length - 1) / 2.0) * this.objYSpace / 2, this.text[i], false);
        }
