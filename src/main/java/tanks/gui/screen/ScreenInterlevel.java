...
public class ScreenInterlevel extends Screen implements IDarkScreen
{
    ...
    Button replayCrusadeWin = new Button(this.centerX, this.centerY, this.objWidth, this.objHeight, "Replay level", () ->
    {
        ...
        Game.screen = new ScreenGame(Crusade.currentCrusade);
    }, "You will not gain extra lives---" + "from replaying a level you've already cleared.---" + "However, you can still earn coins!---"
    ...
    public void draw()
    {
        ...
        save.posX = (Game.game.window.absoluteWidth / Drawing.drawing.interfaceScale - Drawing.drawing.interfaceSizeX) / 2 + Drawing.drawing.interfaceSizeX
                - 50 * Drawing.drawing.interfaceScaleZoom - Game.game.window.getEdgeBounds() / Drawing.drawing.interfaceScale;
        ...
        if (Crusade.crusadeMode)
        {
            ...
            if (Crusade.currentCrusade.lifeGained)
            {
                ...
                Drawing.drawing.displayInterfaceText(this.centerX, this.centerY - this.objYSpace * frac, "You gained a life for clearing Battle %d!",
                        (Crusade.currentCrusade.currentLevel + 1));
            }
        }
