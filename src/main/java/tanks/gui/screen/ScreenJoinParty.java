...
public class ScreenJoinParty extends Screen
{
    ...
    // Button steam = new Button(this.centerX - this.objXSpace / 2, this.centerY -
    // this.objYSpace * 2.5, this.objWidth, this.objHeight, "Join Steam friends", ()
    ...
    public Button join = new Button(this.centerX, this.centerY + this.objYSpace / 2, this.objWidth, this.objHeight, "Join", new Runnable()
    {
        ...
        public void run()
        {
            ScreenPartyLobby.chatbox = new ChatBox(Drawing.drawing.interfaceSizeX / 2, Drawing.drawing.getInterfaceEdgeY(true) - 30, Drawing.drawing.interfaceSizeX - 20, 40,
                    Game.game.input.chat, () -> Game.eventsOut.add(new EventChat(ScreenPartyLobby.chatbox.inputText)));
            ...
            if (ipText.startsWith("steam:") && Game.steamNetworkHandler.initialized)
            {
                ...
                SteamID target = Game.steamNetworkHandler.send(id, new EventSendClientDetails(Game.network_protocol, Game.clientID, Game.player.username),
