...
public class ScreenOptionsMultiplayer extends Screen
{
    ...
    Button hostOptions = new Button(this.centerX, this.centerY - this.objYSpace * 1.5, this.objWidth, this.objHeight, "Party host options",
            () -> Game.screen = new ScreenOptionsPartyHost(), "Options for parties you host");
