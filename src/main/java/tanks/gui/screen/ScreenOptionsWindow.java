...
public class ScreenOptionsWindow extends Screen
{
    ...
    Button fullscreen = new Button(this.centerX + this.objXSpace / 2, this.centerY + this.objYSpace * 0.75, this.objWidth, this.objHeight, "",
            ...
            Translation.translate("Can also be toggled at any time---by pressing %s", Game.game.input.fullscreen.getInputs()));
    ...
    }, "Shows the following information---" + "at the bottom of the screen:---" + "---" + "Game version---" + "Framerate---" + "Network latency (if in a party)---"
            + "Memory usage");
    ...
    public ScreenOptionsWindow()
    {
        ...
        height = new TextBox(Drawing.drawing.interfaceSizeX / 2 + this.objXSpace * 3 / 4, Drawing.drawing.interfaceSizeY / 2 - this.objYSpace * 0.25, this.objWidth * 0.45,
    ...
    public void draw()
    {
        ...
        Drawing.drawing.displayInterfaceText(Drawing.drawing.interfaceSizeX / 2 + this.objXSpace / 2, Drawing.drawing.interfaceSizeY / 2 - this.objYSpace * 1.35,
                "Window resolution");
        width.draw();
        height.draw();
