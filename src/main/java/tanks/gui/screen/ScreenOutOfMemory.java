...
public class ScreenOutOfMemory extends ScreenCrashed
{
    ...
    public void draw()
    {
        ...
        drawing.fillInterfaceRect(Drawing.drawing.interfaceSizeX / 2, Drawing.drawing.interfaceSizeY / 2, Drawing.drawing.interfaceSizeX * 1.2,
                Drawing.drawing.interfaceSizeY * 1.2);
