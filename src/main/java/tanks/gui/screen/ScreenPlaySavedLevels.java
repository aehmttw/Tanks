...
public class ScreenPlaySavedLevels extends Screen
{
    ...
    {
        this.allLevels = new SavedFilesList(Game.homedir + Game.levelDir, ScreenSavedLevels.page, (int) (this.centerX - Drawing.drawing.interfaceSizeX / 2),
                (int) (-30 + this.centerY - Drawing.drawing.interfaceSizeY / 2), (name, file) ->
                {
