...
public class ScreenWorkshopCreations extends Screen
{
    ...
    SearchBox search = new SearchBox(this.centerX, this.centerY - this.objYSpace * 4, this.objWidth * 1.25, this.objHeight, "Search", new Runnable()
    {
        ...
        public void run()
        {
            ...
            if (!Objects.equals(Game.steamNetworkHandler.workshop.searchText, s))
            {
                ...
                Game.steamNetworkHandler.workshop.search(Game.steamNetworkHandler.workshop.searchType, 0, 18, Game.steamNetworkHandler.workshop.searchUser, search.inputText,
    ...
    public void draw()
    {
        ...
        for (int i = Math.min(creations.page * creations.rows * creations.columns + creations.rows * creations.columns, creations.buttons.size()) - 1; i >= creations.page
                * creations.rows * creations.columns; i--)
        {
