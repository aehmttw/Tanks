...
public class Hotbar
{
    ...
    public void draw()
    {
        ...
        if (this.enabledCoins)
        {
            ...
            Drawing.drawing.displayInterfaceText(Drawing.drawing.interfaceSizeX / 2, Drawing.drawing.getInterfaceEdgeY(true) - 100 + percentHidden - verticalOffset, "Coins: %d",
                    coins);
        }
    ...
    public void drawCircle()
    {
        ...
        if (this.enabledHealthBar)
        {
            ...
            double opacity = circleVisibility / circleVisibilityMax
                    * Math.min(1, (Game.playerTank.health == 0 ? 0 : this.circlePersistenceVisibility) + Math.max(0, 2 - timeSinceHealthChange / healthFadeTime));
        ...
        double opacityAllies = circleVisibility / circleVisibilityMax
                * Math.min(1, ((alliedCount > 1) ? this.circlePersistenceVisibility : 0) + Math.max(0, 20 - timeSinceAlliesChange / 50));
        ...
        // livesPos = totalWidth;
        // totalWidth += (30 + Drawing.drawing.getInterfaceTextWidth("" +
        // Game.player.remainingLives)) * opacity1;
