...
public class DefaultItemIcons
{
    public static ItemIcon bullet_normal = new ItemIcon("bullet_normal", "bullet",
            new Color[]{BulletEffect.trail.trailEffects.get(0).frontColor, TankPlayer.default_secondary_color, TankPlayer.default_primary_color}, new Boolean[]{true, false, false})
                    .register();

    public static ItemIcon bullet_mini = new ItemIcon("bullet_mini", "bullet_mini", new Color[]{new Color(0, 0, 0), new Color(0, 0, 0)}, new Boolean[]{false, false}).register();

    public static ItemIcon bullet_large = new ItemIcon("bullet_large", "bullet_large", new Color[]{TankPlayer.default_secondary_color, TankPlayer.default_primary_color},
    ...
    public static ItemIcon bullet_laser = new ItemIcon("bullet_laser", "bullet_laser",
            new Color[]{new Color(255, 0, 0), new Color(255, 40, 40), new Color(255, 80, 80), new Color(255, 0, 0, 0)}, new Boolean[]{false, true, true, true}).register();

    public static ItemIcon bullet_healing = new ItemIcon("bullet_healing", "bullet_laser",
            new Color[]{new Color(0, 255, 0), new Color(120, 255, 120), new Color(160, 255, 160), new Color(0, 255, 0)}, new Boolean[]{false, true, true, true}).register();

    public static ItemIcon bullet_electric = new ItemIcon("bullet_electric", "bullet_electric", new Color[]{new Color(0, 255, 255), new Color(127, 255, 255)},
            new Boolean[]{false, false}).register();

    public static ItemIcon bullet_freeze = new ItemIcon("bullet_freeze", "bullet_freeze", new Color[]{new Color(0, 255, 255), new Color(255, 255, 255), new Color(0, 255, 255)},
    ...
    public static ItemIcon bullet_explosive = new ItemIcon("bullet_explosive", "bullet",
            new Color[]{BulletEffect.trail.trailEffects.get(0).frontColor, new Color(255, 0, 0), new Color(255, 255, 0)}, new Boolean[]{true, false, false}).register();

    public static ItemIcon bullet_boost = new ItemIcon("bullet_boost", "bullet_boost", new Color[]{new Color(255, 182, 7), new Color(255, 235, 18)}, new Boolean[]{false, false})
            .register();

    public static ItemIcon bullet_air = new ItemIcon("bullet_air", "bullet_air", new Color[]{new Color(147, 169, 183), new Color(207, 217, 223)}, new Boolean[]{true, true})
            .register();

    public static ItemIcon bullet_air_strike = new ItemIcon("bullet_air_strike", "bullet_air_strike",
            new Color[]{BulletEffect.fire.trailEffects.get(0).frontColor, new Color(255, 0, 0, 180), new Color(255, 255, 0), new Color(255, 0, 0), new Color(255, 220, 0)},
            new Boolean[]{true, true, true, true, false, false}).register();

    public static ItemIcon mine = new ItemIcon("mine", "mine", new Color[]{TankPlayer.default_secondary_color, TankPlayer.default_primary_color, new Color(255, 220, 0)},
            new Boolean[]{true, true, true}).register();

    public static ItemIcon shield = new ItemIcon("shield", "shield", new Color[]{new Color(170, 170, 170), new Color(230, 230, 230), new Color(170, 110, 50)},
            new Boolean[]{false, true, false}).register();

    public static ItemIcon shield_gold = new ItemIcon("shield_gold", "shield", new Color[]{new Color(255, 160, 0), new Color(255, 220, 0), new Color(170, 110, 50)},
            new Boolean[]{false, true, false}).register();
