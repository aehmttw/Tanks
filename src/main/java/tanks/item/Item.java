...
public abstract class Item extends GameObject
{
    ...
    // Items like bullets and mines can hit enemies, so this will be shown on the
    // stats screen
    ...
    public abstract static class ItemStack<T extends Item> implements ICopyable<ItemStack<T>>, ITanksONEditable
    {
         ...
         *            item
         * @param max
         *            max stack size, set to 0 or negative for infinite
         */
    ...
    public ItemIcon getAutomaticIcon()
    {
        ...
        else if (this instanceof ItemMine)
        {
            ...
            ii.colors.get(2).set(m.initialColor.red * 0.85 + m.finalColor.red * 0.15, m.initialColor.green * 0.85 + m.finalColor.green * 0.15,
                    m.initialColor.blue * 0.85 + m.finalColor.blue * 0.15);
            return ii;
        } else if (this instanceof ItemBullet)
        {
            ...
            } else if (b instanceof BulletInstant)
            {
                ...
                if (b.hitStun > 0)
                {
                    ...
                    ii.colors.get(1).set(secondary.red * 0.635 + primary.red * 0.365, secondary.green * 0.635 + primary.green * 0.365,
                            secondary.blue * 0.635 + primary.blue * 0.365);
                } else if (b.damage >= 0)
                {
            ...
            } else if (b instanceof BulletAirStrike)
            {
                ...
                ii.colors.get(4).set(fireTrailEnd.red * 0.15 + fireTrailStart.red * 0.85, fireTrailEnd.green * 0.15 + fireTrailStart.green * 0.85,
                        fireTrailEnd.blue * 0.15 + fireTrailStart.blue * 0.85);
            ...
            } else if (homing1 != null || fireTrailStart.alpha > 0)
            {
                ...
                ii.colors.get(7).set(fireTrailEnd.red * 0.15 + fireTrailStart.red * 0.85, fireTrailEnd.green * 0.15 + fireTrailStart.green * 0.85,
                        fireTrailEnd.blue * 0.15 + fireTrailStart.blue * 0.85);
                return ii;
            } else
            {
