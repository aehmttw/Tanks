...
@TanksONable("item")
public abstract class Item2 implements IGameObject
{
	...
	@ItemProperty(id = "name", name = "Item name")
	public String name = System.currentTimeMillis() + "";

	@ItemProperty(id = "icon", name = "Icon")
	public String icon;

	@ItemProperty(id = "cooldown", name = "Cooldown")
	...
	public static abstract class ItemStack<T extends Item2>
	{
		@ID("item")
		public T item;
...
//		return null;
	...
	public static Item2 fromString(String s)
	{
		return (Item2) TanksON.parseObject(s);
	}
}
