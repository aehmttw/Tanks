...
{
    public FixedText.types location;
    public String text;
    ...
    public EventDisplayText(FixedText.types location, String text, boolean afterGameStarted, int durationInMs, double r, double g, double b)
    {
