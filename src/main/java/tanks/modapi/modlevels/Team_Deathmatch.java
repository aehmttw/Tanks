package tanks.modapi.modlevels;
...
public class Team_Deathmatch extends ModLevel
{
    public Scoreboard scoreboard;

    public Team_Deathmatch()
    {
    ...
    public void setUp()
    {
        ...
        ModAPI.addObject(new TankNPC("npc", 42, 13, ModAPI.up,"Use this shop at your own risk!\n/shop", "Shop", 255, 0, 0));
