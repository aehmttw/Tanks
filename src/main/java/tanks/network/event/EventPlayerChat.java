...
public class EventPlayerChat extends PersonalEvent implements IChatEvent
{
    ...
    {
        this.message = m;
        this.username = "\u00A7" + (int) p.color.red + "," + (int) p.color.green + "," + (int) p.color.blue + "," + (int) p.color2.red + "," + (int) p.color2.green + ","
                + (int) p.color2.blue + "," + (int) p.color3.red + "," + (int) p.color3.green + "," + (int) p.color3.blue + "|" + p.username;
    }
