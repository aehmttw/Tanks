...
public class EventShootBullet extends PersonalEvent
{
    ...
    public void execute()
    {
        ...
        try
        {
            ...
            Bullet b = sb.item.bullet.getClass().getConstructor(double.class, double.class, Tank.class, boolean.class, ItemBullet.ItemStackBullet.class).newInstance(this.posX,
                    this.posY, t, false, sb);
            b.posZ = posZ;
            b.vX = vX;
            b.vY = vY;
            b.vZ = vZ;
