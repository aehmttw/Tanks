...
public class Face2 implements Comparable<Face2>
{
    ...
    public Face2(ISolidObject2 o, Direction direction, boolean tank, boolean bullet)
    {
        this.owner = o;
    ...
    public Face2(ISolidObject2 o, double x1, double y1, double x2, double y2, Direction direction, boolean tank, boolean bullet)
    {
    ...
    public static void drawDebug()
    {
        ...
        for (Chunk c : Chunk.chunkList)
        {
            ...
            for (Face2 f : c.faces.bottomFaces)
            {
                if (shouldHide(f)) continue;
            ...
            for (Face2 f : c.faces.rightFaces)
            {
                if (shouldHide(f)) continue;
    ...
    public static boolean shouldHide(Face2 f)
    {
