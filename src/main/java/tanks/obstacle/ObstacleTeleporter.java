...
public class ObstacleTeleporter extends Obstacle
{
    ...
    public void draw()
    {
        ...
        if (Game.enable3d)
        {
            ...
            Drawing.drawing.setColor(this.colorR * (2 - this.brightness) / 2, this.colorG * (2 - this.brightness) / 2, this.colorB * (2 - this.brightness) / 2, 255,
                    (2 - this.brightness) / 2);
            Drawing.drawing.fillOval(this.posX, this.posY, height + 6, draw_size * 5 / 8, draw_size * 5 / 8, true, false);
            Drawing.drawing.setColor(this.brightness * this.colorR + 255 * (1 - this.brightness), this.brightness * this.colorG + 255 * (1 - this.brightness),
                    this.brightness * this.colorB + 255 * (1 - this.brightness), 255, (2 - this.brightness) / 2);
