...
public class TeleporterOrb extends Movable
{
    ...
    public void draw()
    {
        ...
        // if (this.tank.size == 0)
        // Game.effects.add(Effect.createNewEffect(this.posX, this.posY, this.posZ,
    ...
    public void update()
    {
        ...
        if (this.age > this.endAge)
        {
            ...
            for (int i = 0; i < 100 * Game.effectMultiplier; i++) this.createEffect();
    ...
    public void updateTrails()
    {
        ...
        if (!this.addedTrail && !this.destroy && (GameObject.absoluteAngleBetween(this.getPolarDirection(), this.lastTrailAngle) >= 0.001
                || (Game.enable3d && GameObject.absoluteAngleBetween(this.getPolarPitch(), this.lastTrailPitch) >= 0.1)))
        {
            this.addTrail();
        }
        ...
        for (Trail t : this.trailSet)
        {
            if (!Game.enable3d)
                this.addTrailObj(new Trail(this, speed, x, y, this.size * speed / 3.125 * t.delay, this.size / 2 * t.backWidth, this.size / 2 * t.frontWidth,
                        this.size * speed / 3.125 * t.maxLength, this.lastTrailAngle, t.frontColor.red, t.frontColor.green, t.frontColor.blue, t.frontColor.alpha, t.backColor.red,
                        t.backColor.green, t.backColor.blue, t.backColor.alpha, t.glow, t.luminosity, t.frontCircle, t.backCircle), i);
            else
                this.addTrailObj(new Trail3D(this, speed, x, y, z, this.size * speed / 3.125 * t.delay, this.size / 2 * t.backWidth, this.size / 2 * t.frontWidth,
                        ...
                        t.frontColor.alpha, t.backColor.red, t.backColor.green, t.backColor.blue, t.backColor.alpha, t.glow, t.luminosity, t.frontCircle, t.backCircle), i);
            i++;
        }
    }
