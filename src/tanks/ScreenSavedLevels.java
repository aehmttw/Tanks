...
public class ScreenSavedLevels extends Screen
{
	...
	Button quit = new Button(Window.interfaceSizeX / 2 - 190, Window.interfaceSizeY / 2 + 300, 350, 40, "Back", new Runnable()
	{
		@Override
		public void run() 
		{
	...
	Button newLevel = new Button(Window.interfaceSizeX / 2 + 190, Window.interfaceSizeY / 2 + 300, 350, 40, "New level", new Runnable()
	{
		@Override
		public void run() 
		{
	...
	public ScreenSavedLevels()
	{
		...
		for (int i = 0; i < buttons.size(); i++)
		{
			...
			buttons.get(i).posY = Window.interfaceSizeY / 2 + yoffset + (i % rows) * 60;

			if (i / rows % 3 == 0)
				buttons.get(i).posX = Window.interfaceSizeX / 2 + offset;
			else if (i / rows % 3 == 1)
				buttons.get(i).posX = Window.interfaceSizeX / 2 + offset + 380;
			else
				buttons.get(i).posX = Window.interfaceSizeX / 2 + offset + 380 * 2;
		}
	...
	public void draw(Graphics g)
	{
		...
		Window.drawInterfaceText(g, Window.sizeX / 2, Window.sizeY / 2 - 210, "My levels");
